<template>
    ...
    <Drawer :sidebar="sidebar" :full_name='full_name' :job_title='job_title' :email='email' :phone_number='phone_number' :address='address' :dob='dob' :bio='bio' />
